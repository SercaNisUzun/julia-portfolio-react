    ...
    return (
        <div className='otherBrands'>
            ...
            <div className='othersContent'>
                ...
                <div>
                    <p>
                        Factsheet «Переезд в Китай» упаковывает всё ключевое: пошаговый тайм-лайн виз и разрешений, обзор банков и рабочих карт (UnionPay, Alipay & WeChat Pay), выбор мобильных операторов, готовые таблицы расходов и способы оплаты, краткие профили городов с арендами и климатом, бытовые лайф-хаки (VPN, переводчики, экстренные номера) и чек-лист документов на выезд / въезд — всё в фирменной графике Maree. Такой гид закрывает повторяющиеся вопросы, экономит время HR и даёт сотруднику готовый план действий от сборов чемодана до первой зарплаты в Китае.
                    </p>
                </div>
