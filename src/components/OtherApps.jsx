    ...
    return (
        <div className="appSliderHeight">
            ...
            <div className='othersContent'>
                ...
                <div className='purpleBgText'>
                    <p><MdOutlineArrowRightAlt className='liArrow' /> <strong>В результате</strong> +20 % к конверсии в подписку и $10 k выручки за первый месяц после запуска, а так же успешная презентация проекта на вет конференции в ЛА</p>
                </div>
